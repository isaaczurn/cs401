...
?>
    ...
    <div class="logincontainer">
        ...
        <form id="login" autocomplete="off" method="post" action="loginuser.php">
            ...
            <input id="password" type="password" name="password" placeholder="Password" pattern="^(?=.*\d).{4,8}$" title="Enter a password 4-8 characters long, with at least one number and one letter" required>
    ...
    <div class="logincontainer">
        ...
        <form id="create" autocomplete="off" method="post" action="createuser.php">
            ...
            <input id="newpassword" type="password" name="password" placeholder="Password" pattern="^(?=.*\d).{4,8}$" title="Enter a password 4-8 characters long, with at least one number and one letter" required>
